...
def test_uhly():
    # sss>0
    assert uhly([158.11388300841898, 364.0054944640259, 206.15528128088303]) == (175.60129464500443, 2.4895529219991284, 1.9091524329963898) 
...
def test_check_prav():
    # sss>0
    assert check_prav([3,4,5]) == True
    assert check_prav([5,5,5]) == False
